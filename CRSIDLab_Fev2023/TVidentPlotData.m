function TVidentPlotData(pHandle,pSys,userOpt)
% TVidentPlotData Plots time varying system data in TVidentMenu
%   TVidentPlotData(pHandle,pSys,userOpt) plots the signals that compose the
%   time varying system, stored in pSys's userData property to handle pHandle.
%
% Adapted by: André L. S. Ferreira, June 2019.
