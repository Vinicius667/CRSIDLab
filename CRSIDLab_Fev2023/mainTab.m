function mainTab(pnMain,pFile,pTemp,pSig,pSys,pMod,pInfo,userOpt,tbPre,...
...
pbEditRecord = uicontrol('parent',pnRecord,'style','push','string',...
    'Edit','Callback',{@mainRecEdit,teID,txRecord,pInfo,pFile,userOpt},...
...
set(pbOpen,'Callback',{@openPatientFile,pFile,pSig,pSys,pMod,pInfo,teID,...
...
set(pbCreate,'Callback',{@createPatientFile,teID,teDir,pFile,pTemp,pSig,...
    pSys,pMod,pInfo,lbVar,txRecord,pbEditRecord,pbSaveRecord,tbPre,tbAn,...
...
function openPatientFile(~,~,pFile,pSig,pSys,pMod,pInfo,teID,teDir,...
    lbVar,txRecord,pbEditRecord,pbSaveRecord,tbPre,tbAn,txData,userOpt)
...
if ~errStat
    ...
    set(pInfo,'userData',patient.info);
...
function createPatientFile(~,~,teID,teDir,pFile,pTemp,pSig,pSys,pMod,...
    pInfo,lbVar,txRecord,pbEditRecord,pbSaveRecord,tbPre,tbAn,txData,...
